...
import '../../view/main_player/driver_mode_view.dart';
import '../../view/main_player/play_playlist_view.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                PlayerBottomButton(
                    title: "Playlist",
                    icon: "asset/img/playlist.png",
                    onPressed: () {
                      Get.to( () => const PlayPlayListView() );
                    }),
                PlayerBottomButton(
                    title: "Shuffle",
                    icon: "asset/img/shuffle.png",
                    onPressed: () {}),
                PlayerBottomButton(
                    title: "Repeat",
